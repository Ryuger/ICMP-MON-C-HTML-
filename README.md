...
- Добавление/редактирование хостов в web UI + переход в детальную карточку хоста.
...
- Клик по хосту открывает `/host?id=...`.
- Слева: группа/подгруппа, IP, текущий статус, OK/Fail (потери), last/avg/min/max, количество сэмплов.
