...
```
При запуске программа покажет список доступных активных IPv4-интерфейсов и предложит выбрать номер интерфейса для HTTP сервера.

Веб интерфейс будет доступен на выбранном IP, например: `http://192.168.1.10:8080/`.
